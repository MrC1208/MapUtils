...
public class LocatManager {
     ...
     */
    public void startLocate(Context context , AMapLocationClient mLocationClient, AMapLocationClientOption mLocationOption, boolean isOneLocate, long interval, final OnLocationListener listener) {
    ...
    public void drawLine2Map(AMap aMap, List<LatLng> latLngList) {
        Polyline polyline = aMap.addPolyline(new PolylineOptions().addAll(latLngList).width(5).color(R.color.blue));
    }
    ...
    private void initPointMove(AMap aMap, List<LatLng> points) {
        ...
        // 设置滑动的图标
        smoothMarker.setDescriptor(BitmapDescriptorFactory.fromResource(R.drawable.icon_location));
     ...
     */
    public void latlng2Address(Context context,LatLonPoint latLonPoint, float range, String searchType, OnPoiCallbackListener callbackListener) {
        // 第一个参数表示一个Latlng，第二参数表示范围多少米，第三个参数表示是火系坐标系还是GPS原生坐标系
        initPoi(context,callbackListener);
        RegeocodeQuery query = new RegeocodeQuery(latLonPoint, range, searchType);
        geocoderSearch.getFromLocationAsyn(query);
    }
    public void latlng2Address(Context context ,LatLonPoint latLonPoint, OnPoiCallbackListener callbackListener) {
        // 第一个参数表示一个Latlng，第二参数表示范围多少米，第三个参数表示是火系坐标系还是GPS原生坐标系
        initPoi(context,callbackListener);
     ...
     */
    public void address2Latlng(Context context,String address, String cityCodeOrcityName, OnPoiCallbackListener callbackListener) {
        initPoi(context,callbackListener);
     ...
     * 初始化
     */
    private void initPoi(Context context ,final OnPoiCallbackListener listener) {
